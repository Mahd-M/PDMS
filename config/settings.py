...
# collectstatic's target dir -- required for WhiteNoise's manifest storage
# below to have somewhere to write hashed, compressed copies into.
STATIC_ROOT = BASE_DIR / "staticfiles"
MEDIA_URL = "media/"
MEDIA_ROOT = BASE_DIR / "media"

# gunicorn (Step 44) has no built-in static file serving, unlike
# `manage.py runserver` -- WhiteNoise serves STATIC_ROOT efficiently
# from inside the same process, which is exactly right for a small
# deployment that doesn't warrant a separate CDN.
STORAGES = {
